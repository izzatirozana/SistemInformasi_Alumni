            ...
            <div class="card-body" >
              <!-- AWAL FORM -->
               ...
               <?php 
                include 'koneksi.php';
                $NISN = $_GET['NISN'];
                $data = mysqli_query($koneksi, "select * from alumni where NISN='$NISN'");
                while ($d = mysqli_fetch_array($data)) {
                  ?>
              <form method="post" action="update-alumni.php">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="Thn_masuk" value="<?php echo $d['Thn_masuk']; ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Nama Universitas</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="Universitas" value="<?php echo $d['Universitas']; ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Fakultas</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="Fakultas" value="<?php echo $d['Fakultas']; ?>">
                  </div>
                </div>
                <div class="form-group row">

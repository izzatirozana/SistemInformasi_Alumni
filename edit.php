      ...
      <div class="card ">
        ...
        <div class="card-body" >
          <div class="d-flex justify-content-end">
            <a type="button" class="btn btn-outline-warning disabled" style="margin-right: 5px;">Edit Data Alumni</a>
          ...
          <div class="card mt-3" >
            <div class="card-body" >
              ...
              <?php 
                include 'koneksi.php';
                $NISN = $_GET['NISN'];
                $data = mysqli_query($koneksi, "select * from bio_siswa where NISN='$NISN'");
              ...
              <form method="post" action="update.php">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="number" readonly class="form-control" name="NISN" value="<?php echo $d['NISN']; ?>">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <fieldset class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <div class="form-check form-check-inline">
                      <?php 
                      if ($d['jk'] == "Laki-Laki") {
                      echo "<input class='form-check-input' type='radio' name='jk' id='jk1' value='Laki-Laki' checked>";
                      ?>
                    ...
                    <?php
                      echo "<input class='form-check-input' type='radio' name='jk' id='jk2' value='Perempuan' checked>";
                      ?>
                      <label class="form-check-label" >Perempuan</label>
                      <?php
                        }
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="Angkatan" value="<?php echo $d['Angkatan']; ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Alamat</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" name="Alamat" rows="4" ><?php echo $d['Alamat']; ?></textarea>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">No Telpon</label>
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="No_telp" value="<?php echo $d['No_telp']; ?>">
                  </div>
                </div>
                <div class=" d-flex justify-content-end">
